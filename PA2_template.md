...
### Environment used
The study was conducted on a 64-bit Windows 8.1 machine with 4 cores and 16 GB of RAM

Developed with RStudio version 0.98.1103

R language was R version 3.2.0 (2015-04-16)

Published on `rpubs.com`

The project may be found on Github at `https://github.com/wagnersq/RepData_PeerAssessment2`
...
```
## Warning: package 'R.utils' was built under R version 3.2.1
```
...
```
## Warning: package 'R.oo' was built under R version 3.2.1
```
...
```
## Warning: package 'R.methodsS3' was built under R version 3.2.1
```
...
### Conclusion  
  In summary, we found that **excessive heat** and **tornado** are most harmful with respect to population health, both in terms of fatalities and injuries, over the years from 1950 to 2011. While **flood**, **drought**, and **hurricane/typhoon** have the greatest economic consequences, whith Tornado only at 3rd place.
